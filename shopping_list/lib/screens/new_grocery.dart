...
class NewGrocery extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _NewGroceryState();
}
...
class _NewGroceryState extends State<NewGrocery> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Add a new grocery"),
      ),
      body: Padding(
              ...
              Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    child: _isSending ? const SizedBox(height: 16, width: 16, child: CircularProgressIndicator(),) : const Text("Save Item"),
                  ),
                ],
              ),
            ],
